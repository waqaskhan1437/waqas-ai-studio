...
const SAMPLE_URDU_MANIFEST: ScriptManifest = {
  ...
  tts_text: "क्या आप जानते हैं के छोटी सी आदत आप की पूरी ज़िंदगी बदल सकती है?",
  segments: [
    {
      id: "hook",
      kind: "hook",
    ...
    },
    {
      ...
      tts_text: "आख़िर तक देखें, तरीक़ा बहुत आसान है।",
    ...
    },
    {
      ...
      tts_text: "रोज़ सिर्फ़ पाँच मिनट अपने अहम काम के लिए मुख़्तस करें। जब ये अमल मुसलसल दोहराया जाता है तो दिमाग़ इसे मुश्किल काम नहीं समझता, बल्कि एक फ़ितरी मामूल बना लेता है।",
    ...
    },
    {
      ...
      tts_text: "आज ही पाँच मिनट से शुरू करें, और ये वीडियो किसी ऐसे शख़्स के साथ शेयर करें जो अपनी ज़िंदगी बदलना चाहता है।",
